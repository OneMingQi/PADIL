...
from algorithms.rlkit.torch.utils.pytorch_util import set_gpu_mode
import collections
...
def create_mounts(
    ...
    from algorithms.rlkit.launchers import (
        config,
    )  # Import the module that contains CODE_MOUNTS
    ...
    mounts = [m for m in config.CODE_MOUNTS]  # Use the imported CODE_MOUNTS variable
    from algorithms.rlkit.launchers import mount  # Import the missing module
    ...
    from algorithms.rlkit.launchers.config import NON_CODE_MOUNTS
