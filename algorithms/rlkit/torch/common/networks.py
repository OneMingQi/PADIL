...
from algorithms.rlkit.data_management.normalizer import FixedNormalizer
from algorithms.rlkit.torch.utils import pytorch_util as ptu
from algorithms.rlkit.torch.core import PyTorchModule
from algorithms.rlkit.torch.common.modules import LayerNorm
...
class FlattenMlp(Mlp):
    ...
    def forward(self, *inputs, **kwargs):
        ...
        #     print(f"inputs[{i}] type: {type(input)}")
        #     if isinstance(input, torch.Tensor):
        #         print(f"inputs[{i}] dtype: {input.dtype}, shape: {input.shape}, content: {input}")
        #     else:
        #         print(f"inputs[{i}] content: {input}")
